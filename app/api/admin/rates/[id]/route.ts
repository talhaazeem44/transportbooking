...
export async function PATCH(req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  const { destination, tariff, carType } = body;
  ...
  return NextResponse.json({ id: String(updated._id), destination: updated.destination, tariff: updated.tariff, carType: updated.carType });
}
